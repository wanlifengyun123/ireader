...
public class PullToRefreshView extends LinearLayout
{
    ...
    private void init()
    {
        ...
        // header view 在此添加,保证是第1个添加到linearlayout的最上端
        addHeaderView();
    }
    ...
    private void addHeaderView()
    {
        ...
        // 设置topMargin的topMargin为负的header View高度,即将其隐藏在朢�上方
    ...
    private void addFooterView()
    {
        ...
        // int top = getHeight();
        // params.topMargin
        // =getHeight();//鍦ㄨ繖閲実etHeight()==0,浣嗗湪onInterceptTouchEvent()鏂规硶閲実etHeight()宸茬粡鏈夊€间簡,涓嶅啀鏄?;
    ...
    private boolean isRefreshViewScroll(int deltaY)
    {
        ...
        if (mAdapterView != null)
        {
            ...
            if (deltaY > 0)
            {
                ...
                {// 杩欓噷涔嬪墠鐢?鍙互鍒ゆ柇,浣嗙幇鍦ㄤ笉琛?杩樻病鎵惧埌鍘熷洜
                    mPullState = PULL_DOWN_STATE;
                    return true;
                }
     ...
     * header refreshing
     *
     * @description willm 2012/12/4 涓婂崍 12:06
     */
     ...
     * footer refreshing
     *
     * @description willm 2012/12/4 涓婂崍 12:07
     */
     ...
     *
     * @description
     * @return willm 2012/12/4 涓婂崍 12:08
     */
